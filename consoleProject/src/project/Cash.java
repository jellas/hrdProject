...
public class Cash {
	...
	// 변수 지정
	static int point = 50000; // 레드 회원에게 지원되는 포인트
	static int total = 0; // 합계
	static int price; // 영화표 가격
	static int cash; // 현금
	static int difference; // 차액
	static int pcash; // 차액
	static int dcash;

	// 레드 회원, 비회원 리스트
	static Map<String, Integer> rCashGrade = new LinkedHashMap<>();
	static Map<String, Integer> nCashGrade = new LinkedHashMap<>();

	/**
	 * 예매 페이지
	 */
	protected static void ticketing() {
	 ...
	 * 비회원 결제창
	 */
	public static void nCheckout(int price) {
	 ...
	 * 레드 회원 결제창
	 */
	public static void rCheckout(int price) {
	 ...
	 * 현금 결제하기
	 */
	public static void paymentOnCash(int price) {
	 ...
	 * 포인트 결제하기
	 */
	public static void paymentOnPoint(int price) {
	 ...
	 * 카드 계산
	 */
	public static void paymentOnCard(int price) {
	 ...
	 * 현금 차액 지불하기
	 */
	public static void differencePayment(int dcash) {
