...
public class Behind {
	 ...
	 * 2. 상영작 예매하기 -> 영화 예매
	 */
	static Map<Integer, String> first = new TreeMap<>();
	static Map<Integer, String> second = new TreeMap<>();
	...
	private static String input(int join) {
	 ...
	 * 이스터 에그-영화 평론
	 */
	private static void peemang(String title) {
